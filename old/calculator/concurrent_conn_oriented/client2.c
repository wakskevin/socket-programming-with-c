...
// function prototypes
int getuserinput(char buffer[BUFSIZ]); // function to get user input and formats it into appropriately string based on the application protocol
...
int main()
{
    ...
    r = getaddrinfo("127.0.0.1", "8854", &hints, &server);
